...
const sheetDistrictMap = {
  // "Ariyalur Beds": "5ea0abd3d43ec2250a483a4f", 
  // "chengalpattu Beds": "5ea0abd4d43ec2250a483a61",
  ...
  "Nagercoil Beds": "5ea0abd3d43ec2250a483a5c", 
  // "Karur Beds": "5ea0abd3d43ec2250a483a4c",
  // "krishnagiri Beds": "5ea0abd3d43ec2250a483a5d", 
  "Madurai Beds": "5ea0abd3d43ec2250a483a56",
  ...
  "Salem Beds": "5ea0abd2d43ec2250a483a46", 
  // "sivagangai beds": "5ea0abd3d43ec2250a483a55",
  // "tenkasi Beds": "5ea0abd4d43ec2250a483a60", "Thanjavur Beds": "5ea0abd3d43ec2250a483a53",
  // "Theni Beds": "5ea0abd3d43ec2250a483a57", 
  "Thiruchirappalli Beds": "5ea0abd3d43ec2250a483a57",
...
async function fetchData(url = 'https://tncovidbeds.tnega.org/api/hospitals'){

  districtOutputJsonArray = []
  for (let sheetName in sheetDistrictMap) {
    console.log(sheetName+"=="+sheetDistrictMap[sheetName]);
    response = await axios.post(url, {
      Districts: [sheetDistrictMap[sheetName]],
      ...
      districtOutputJsonArray.push(...response)
  }

  return districtOutputJsonArray
}
