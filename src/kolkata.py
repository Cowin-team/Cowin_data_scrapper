...
if __name__ == '__main__':
    ...
    driver = webdriver.Chrome("C:\\Users\\Hemanth Chenchu\\Downloads\\chromedriver_win32\\chromedriver.exe")
    ...
    for html in html_text:
        ...
        for row in rows:
            ...
            if header:
                ...
                data['Phone Number'] = header.find('a').text.strip()
                ...
                data['Ventilators'] = ventilator_beds.find_all('h3')[-1].text
