...
for key,value in district_list.items():
  ...
  mp_bedlist=pd.DataFrame({"Name":HospitalName,"Map Link":Map,"Bed Status":BedStatus,"COVID Beds":IsolationBeds,"Oxygen Beds":OxygenSupported,"ICU":ICUavailable,"LAST UPDATED":last_updated,"ContactInformation":contactInfo,"Sheet Name":sheetname,"Address": address,"Check LAST UPDATED":False})
