...
## Food delivery Old meal services -- Do not use. Old version
...
cleaned_df = get_clean_contact_info(df,'Contact')
...
harshini=treat_duplicates(harshini,'Phone Number',['Area', 'Order Placement', 'Delivery Option',
...
murshitha = treat_duplicates(murshitha,'Phone Number',['Location of Kitchen', 'Delivery Mode', 'Any other details you would like to share?',
...
final_meals_df = treat_duplicates(meals_df,'Phone Number',[ 'Type','Comments', 'Cost Type']).fillna('No Value Present')

## Store dataframe
final_meals_df.to_csv('tamil_nadu_meals.csv')